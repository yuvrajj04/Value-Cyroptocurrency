...
const Header = () => {
  return (
    <header className="p-[32px] mx-[78px] flex justify-between items-center bg-black text-white font-poppins">
      <div className="text-[26px] font-normal">VALUE</div>
        <nav className="flex justify-center items-center space-x-[44px] text-[14px]">
