            ...
            <div className='flex flex-col bg-[#484848] '>
                <div className="relative  pt-[92px]  pb-[180px]">
                    ...
                    <div className="flex flex-col items-center z-40">
                        ...
                        <span className="text-white text-[60px] font-semibold mt-[-20px]">Why choose our bigtech</span>
                        <span className="text-[#FEFF05] text-[60px] font-semibold mt-[-20px]">Token</span>
                    </div>
                </div>
            </div>

            <div className="flex gap-[64px] w-full justify-center items-center mt-[-116px] z-[40] ">
                <div className="relative rounded-[30px] p-12 border-[0.8px] card-gradient  border-[white] w-[308px] h-[355px] flex flex-col gap-6 justify-center items-start">
