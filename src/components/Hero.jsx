    ...
    return (
        <div className='flex flex-col relative w-auto md:w-full h-auto overflow-hidden font-Poppins font-normal my-[40px] md:my-[80px]'>
            ...
            <div className="flex flex-col w-full z-50 items-center font-normal gap-[12px] md:gap-0 font-poppins">
                ...
                <span className="text-white text-[32px] md:text-[103px] !mt-[-32px] font-black fade-in"> CRYPTO <span className="font-black text-stroke-white-2  !text-black"> CURRENCY</span></span>
            ...
            <div className="group flex w-full justify-center items-center mt-[28px] md:mt-[56px] z-50 gap-[16px]">
            ...
            <div className="flex flex-nowrap gap-[64px] md:gap-[200px] w-full justify-start md:justify-center px-4 md:px-0 items-center mt-[56px] z-50 overflow-x-auto md:overflow-hidden overflow-hidden">
                <div className=" flex-shrink-0 relative items-center rounded-[16px] md:rounded-[30px] border-[0.8px] border-[white] px-[36px] w-[200px] md:w-[261px] h-[160px] md:h-[261px] flex flex-col justify-center">
                    ...
                    <span className="text-white text-[25px] z-[40] text-center">Wallet Types</span>
                </div>
                <div className="flex-shrink-0 relative items-center rounded-[16px] md:rounded-[30px] border-[0.8px] border-[white] px-[36px] w-[200px] md:w-[261px] h-[160px] md:h-[261px] flex flex-col justify-center">
                    <div className="absolute left-[-2px] w-[262.6px] h-[262.6px] black-card-fade-down rounded-[30px] z-[30]"></div>
                    <span className="text-[#DFDE02] text-[24px] md:text-[50px] font-bold  z-[40]">2000+</span>
                    <span className="text-white text-[25px] text-center">Wallet Types</span>
                </div>
                <div className="flex-shrink-0 relative items-center rounded-[16px] md:rounded-[30px] border-[0.8px] border-[white] px-[36px] w-[200px] md:w-[261px] h-[160px] md:h-[261px] flex flex-col justify-center">
                    <div className="absolute left-[-2px] w-[262.6px] h-[262.6px] black-card-fade-down rounded-[30px] z-[30]"></div>
