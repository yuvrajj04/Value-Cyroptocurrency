  ...
  return (
    <>
        <footer className=" text-white pt-10">
            ...
            <div className="flex flex-row space-x-[200px] justify-center items-center mb-[80px] ">
                ...
                <div className="flex-col p-4 space-y-[40px]">
                    ...
                    <div className="h-[48px] w-[400px] flex shadow rounded-l-full p-l-[24px] overflow-hidden mb-4">
                        <input  type="text"
                        ...
                        <button
                        // onClick={}
                        className='outline-none bg-[#DFDE02] text-black px-3'
                        >Subscribe</button>
                    </div>
