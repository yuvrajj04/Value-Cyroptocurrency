...
const JoinTeam = () => {
  return (
    <>
        <div className="flex justify-center px-[150px] md:py-[80px]">
          <div className="relative flex flex-col max-w-[300px] md:max-w-[1270px] gap-[28px] md:gap-[40px] text-white my-[40px] md:my-[40px] mx-[20px] md:mx-[170px] rounded-[24px] border-[1px] border-white px-[60px] md:px-[80px] py-[30px] md:py-[40px] md:justify-center items-center ">
              ...
              <div className="flex flex-wrap gap-[24px] justify-center items-center w-[240px] md:w-auto">
                  <span className="md:flex text-center font-montserrat font-bold text-[24px] md:text-[32px] px-[20px] md:px-0">Interested to<span className="text-[#FEFF05] md:pl-[10px]"> Join Our Team?</span></span>
